...
public class ExampleMod implements ModInitializer {
    ...
    public static boolean isFeatureA_Active = false;
    private static boolean isFeatureB_Harvest = false;
    private static boolean isFeatureB_Plant = false;
    public static boolean isFeatureC_Render = false;
